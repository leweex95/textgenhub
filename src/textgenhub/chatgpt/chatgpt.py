...
def ask(prompt: str, headless: bool = True, remove_cache: bool = True, debug: bool = False, timeout: int = 120) -> str:
    """
    ...
    return provider.ask(prompt, headless, remove_cache, debug, timeout)
