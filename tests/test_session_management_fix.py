...
def run_all_tests():
    ...
    tests = [
        ("JavaScript context error fix (setTextValue)", SessionManagementTests.test_browser_manager_set_text_value_fix),
        ("Session validation improvements", SessionManagementTests.test_session_validation_improvements),
        ("Popup handling improvements", SessionManagementTests.test_popup_handling_improvements),
        ("Browser reset preserves cookies", SessionManagementTests.test_browser_reset_preserves_cookies),
        ("Text input retry logic", SessionManagementTests.test_retry_logic_for_text_input),
        ("Element detection retry logic", SessionManagementTests.test_element_detection_retry_logic),
    ]
