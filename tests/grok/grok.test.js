...
const GrokProvider = require('../../src/textgenhub/grok/grok');

describe('Grok Provider Tests', () => {
    let provider;
    ...
    after(async () => {
        if (provider) {
            try {
                ...
                console.log('Grok provider cleanup completed');
            } catch (error) {
                console.error('Error during Grok cleanup:', error);
            }
        }
    });
